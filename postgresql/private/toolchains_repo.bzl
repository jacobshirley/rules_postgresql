...
# By default all these toolchains are registered by the postgresql_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:postgresql_toolchain",
    toolchain_type = "@rules_postgresql//postgresql:toolchain_type",
)
""".format(
            platform = platform,
